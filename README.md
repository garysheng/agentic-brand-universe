...
|  | Value | Source |
|---|---|---|
| Spec | v0.24 | `SPEC.md`, dated 2026-08-01 |
| Engine conforms to | v0.24 | `engine/agenticstory/__init__.py` |
| Engine version | v0.0.1 | `engine/agenticstory/__init__.py` |
| Skills | 33 | `skills/*/SKILL.md` |
| CLI verbs | 23 | `abu --help` |
| Agents | 1 | `agents/*.md` |
| Commands | 1 | `commands/*.md` |
| Tests | 857 | across 42 files; `./run-tests.sh` |
