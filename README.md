...
- **Install and first render:** [`QUICKSTART.md`](./QUICKSTART.md) — the smallest useful slice is a
  style pack plus a gate, which needs no universe at all.
...
| CLI verbs | 19 | `agenticstory --help` |
| Tests | 560 | across 23 files; `./run-tests.sh` |
...
The table above is generated by `agenticstory build-docs`, and `build-docs --check` runs inside
